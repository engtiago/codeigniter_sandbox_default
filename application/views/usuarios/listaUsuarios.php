      ...
      <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
        <div class="card-body">
          ...
          <div class="form-check form-check-inline">
            ...
            echo form_label("Somente Demitidos", 'status');
            echo form_checkbox(
              array(
                'name'          => 'status',
                'id'            => 'status',
          ...
          ?>
          <p>Ao marcar a opção de somente demitidos a data considerada será a de demissão.</p>
         ...
         <?php echo form_label("Pesquisar Nome:", "pesquisa");?>
          <div class="row text-center my-3">
            ...
            <div class="col-4 col-sm-3">
              <?php echo form_button(array(
                "class" => "btn btn-info",
                "content" => "Pesquisar ".'<i class="fas fa-search"></i>',
                "type" => "submit"
              )); ?>
            </div>
          </div>
      ...
      <?php foreach ($usuarios as $usuarios) : ?>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel"> <i class="fas fa-laptop-code"></i> Incluir Recursos</h5>
                  ...
                  <?php
                    ...
                    if (count($sistemas) <> count($usuariosProgramas[$usuarios['codigo']])) {
                      echo form_button(array(
                        ...
                        "content" => "Incluir Recursos <i class='fas fa-plus'></i>",
                        "type" => "submit"
                      ));
                    } else {
                      echo '<p>Não existem Recursos para inclusão</p>';
                    }
                    echo form_close();
                    ?>
                </div>
        ...
        <div class="modal fade" id="excluir_<?= $usuarios['codigo'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"> <i class="far fa-trash-alt"></i> Excluir Recursos</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
                ...
                <?php
                  ...
                  if (!count($sistemas) <> count($usuariosProgramas[$usuarios['codigo']])) {
                    echo form_button(array(
                      ...
                      "content" => 'Excluir Recursos <i class="far fa-trash-alt"></i>',
                      "type" => "submit"
                    ));
                  } else {
                    echo '<p>Não existem Recursos para Excluir</p>';
                  }
                  echo form_close();
                  ?>
              </div>
